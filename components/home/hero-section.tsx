...
import { MotionDiv, MotionH1, MotionH2, MotionP, MotionSection, MotionSpan } from "@/components/common/motion-wrapper";
    ...
    >
      <MotionDiv variants={itemVariants} className="relative p-[1px] overflow-hidden rounded-full bg-linear-to-r from-rose-200 via-rose-500 to-rose-800 animate-gradient-x group">
        ...
        >
          ...
          <MotionP className="text-base text-rose-600">Powered by AI</MotionP>
        </Badge>
      </MotionDiv>
      ...
      <MotionDiv variants={itemVariants} whileHover={buttonVariants}>
        ...
        >
          <Link href={"/#pricing"} className="flex gap-2 items-center">
            <MotionSpan className="">Try Sommaire</MotionSpan>
