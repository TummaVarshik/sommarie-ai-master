  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-center gap-4">
        <Skeleton className="h-8 w-32 rounded-full bgwhite/80" />
        <Skeleton className="h-5 w-40 rounded-full bgwhite/80" />
      </div>
      ...
      <div className="container mx-auto flex flex-col gap-4">
        <div className="px-4 sm:px-6 lg:px-8 py-6 sm:py-12 lg:py-24">
          <div className="flex flex-col gap-8">
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-4 text-sm text-primary-foreground">
