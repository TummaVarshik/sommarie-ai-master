    ...
    <div className="flex flex-col sm:flex-row gap-4 mb-8 justify-between">
      <div className="flex flex-col gap-2">
        <MotionH1
          ...
          initial="hidden"
          animate="visible"
          className="text-3xl sm:text-4xl font-bold tracking-tight bg-linear-to-r from-gray-600 to-gray-900 bg-clip-text text-transparent"
        >
...
export default function LoadingSummarie() {
  return (
    <div className="min-h-screen relative">
      <BgGradient className="from-emerald-200 via-teal-200 to-cyan-200" />
      <section className="container px-4 sm:px-6 lg:px-8 py-6 sm:py-12 lg:py-24 mx-auto flex flex-col gap-4">
        <HeaderSkeleton />
